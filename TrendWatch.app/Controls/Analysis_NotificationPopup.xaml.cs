...
public partial class Analysis_NotificationPopup : Popup
{
    ...
    public Analysis_NotificationPopup(string title,string message,string icon,Color iconColor,bool canTry,string closeButtonText,string tryAgainMessage)
	{
        DialogTitle = title;
